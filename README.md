...
2. Галерея, состоящая из карточек с фотографиями и их описаниями. Каждой карточке можно поставить лайк (пока только визуально).

**Планы на будущее**

В ближайших планах сделать следующее:

1. Возможность добавлять новые фотографии
2. Редактировать фотографию пользователя
3. Ставить лайки.
